import { serialExcelAISO, parseTablaXLSX } from "@/lib/xlsx-lite";
 ...
 *
 * El .xlsx se lee SIN dependencias nuevas con `src/lib/xlsx-lite.ts` (extraído de acá mismo en
 * C23, docs/PLAN_PAS_ZONAS.md §4.a — un .xlsx es un ZIP con central directory + deflate raw,
 * mismo truco que `scripts/ingest-usda.mjs` con el bulk del PSD). Las fechas pueden venir como
 * serial numérico de Excel (epoch 1899-12-30) o como texto DD/MM/AAAA — se manejan ambas.
 *
