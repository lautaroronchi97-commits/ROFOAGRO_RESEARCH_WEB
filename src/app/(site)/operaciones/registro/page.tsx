...
/**
 * Registro diario (C31, docs/PLAN_OPERACIONES_CLIENTES.md §5.6/§8): carga de
 * compras/ventas del día + neto del día. Mismo `empresaId` explícito que
 * `/operaciones` (nunca del form para un cliente — sale de `getAcceso()`).
 */
export const metadata: Metadata = {
  title: "Registro diario · Mis operaciones · ROFO AGRO",
    ...
    <main className="wrap">
      <div className="col">
        ...
        <Panel id="op-registro">
          <PanelHead title="Registro diario" sub="compras, ventas y neto del día" />
          <RegistroClient
            empresaId={empresaId}
